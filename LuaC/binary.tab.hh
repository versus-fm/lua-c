...
#line 64 "binary.tab.hh" // lalr1.cc:371
...
namespace yy {
#line 87 "binary.tab.hh" // lalr1.cc:371
  ...
  public:
    ...
    union union_type
    {
      ...
      // elseifs
      // optelseifs
      char dummy7[sizeof(std::list<Statement*>)];
    ...
    , value ()
  {
      switch (other.type_get ())
    {
      ...
      case 59: // elseifs
      case 60: // optelseifs
        value.copy< std::list<Statement*> > (other.value);
        break;
    ...
    , value ()
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 59: // elseifs
      case 60: // optelseifs
        value.copy< std::list<Statement*> > (v);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const Call* v)
    : Base (t)
    , value (v)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const ExpressionList* v)
    : Base (t)
    , value (v)
  {}

  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const Function* v)
    : Base (t)
    , value (v)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::list<Statement*> v)
    : Base (t)
    , value (v)
  {}
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 59: // elseifs
      case 60: // optelseifs
        value.move< std::list<Statement*> > (s.value);
        break;
...
#line 1973 "binary.tab.hh" // lalr1.cc:371
